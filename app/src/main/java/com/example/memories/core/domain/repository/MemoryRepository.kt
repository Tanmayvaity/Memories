...
interface MemoryRepository {
    ...
    fun searchMemories(query: String, showHidden: Boolean): Flow<PagingData<MemoryWithMediaModel>>

    fun getAllMediaPaged(showHidden: Boolean): Flow<PagingData<MediaModel>>
